...
function updateRange() {
    ...
    lowValue.style.background = "#e0194a";

    const space = document.getElementById("space");
    space.style.flex = high - low + "%";
    space.style.background = "#0dcd38";

    const highValue = document.getElementById("high");
    highValue.style.flex = 100 - high + "%";
    highValue.style.background = "#e0194a";
}
...
function compareGuess() {
    ...
    if(userGuess > computerGuess) {
        ...
        document.getElementById("textOutput").innerHTML = "Correct! You guessed the number in " + attempts + " attempts!";
        gameEnded();
